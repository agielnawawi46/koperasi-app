    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div class="space-y-1">
            <div class="flex items-center gap-3">
                <h1 class="text-3xl font-extrabold text-slate-800 tracking-tight">Input Angsuran</h1>
            </div>
                    ...
                    <form class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <div class="relative group">
                                <select onchange="activateForm(this)" class="w-full bg-slate-50 border-2 border-transparent rounded-2xl px-6 py-4 text-sm font-bold text-slate-700 focus:border-blue-500 focus:bg-white focus:ring-0 transition-all cursor-pointer appearance-none">
                                    <option value="">Pilih Anggota Aktif...</option>
                                    <option value="1">PJ-2026-001 | Agiel Syah</option>
                                    <option value="2">PJ-2026-005 | John Doe</option>
                                </select>
                        ...
                        <div class="opacity-20 pointer-events-none space-y-2 transition-all duration-700" id="inputSet1">
                            ...
                            <input type="number" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-blue-500 transition-all" placeholder="Misal: 5">
                        </div>
                        ...
                        <div class="opacity-20 pointer-events-none space-y-2 transition-all duration-700" id="inputSet2">
                            ...
                            <select class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-blue-500 transition-all appearance-none">
                        ...
                        <div class="md:col-span-2 opacity-20 pointer-events-none space-y-2 transition-all duration-700" id="inputSet3">
                            ...
                            <div class="relative">
                                <input type="number" class="w-full bg-slate-50 border-none rounded-2xl px-14 py-5 text-xl font-black text-slate-800 focus:ring-2 focus:ring-blue-500 transition-all" placeholder="0">
                        ...
                        <div class="relative z-10 space-y-8">
                            <div class="flex justify-between items-start">
                                <div class="space-y-1">
                                    ...
                                    <h3 class="text-xl font-bold">Agiel Syah</h3>
                                </div>
                                <div class="px-4 py-2 bg-white/20 backdrop-blur-md rounded-xl text-[10px] font-black border border-white/20 uppercase tracking-widest">PJ-2026-001</div>
                            </div>
                            <div>
                                <p class="text-4xl font-black tabular-nums tracking-tight">Rp 8.420.000</p>
                                <p class="text-xs font-medium text-blue-100 mt-2 italic">Sisa 8 kali angsuran lagi</p>
                            </div>
                            <div class="grid grid-cols-2 gap-6 pt-4 border-t border-white/10">
                                <div>
                                    ...
                                    <p class="text-sm font-bold uppercase tracking-tight">12 Maret 2026</p>
                                </div>
                                <div>
                                    <p class="text-[9px] font-black uppercase tracking-widest text-blue-200">Jatuh Tempo</p>
                                    <p class="text-sm font-bold uppercase tracking-tight">10 April 2026</p>
                                </div>
                            </div>
                        </div>
                    </div>
