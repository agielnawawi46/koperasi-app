<aside class="w-64 min-h-screen bg-blue-900 text-white flex flex-col">
    ...
    <nav class="space-y-5 p-5">
        ...
        <a href="#" class="block p-2 rounded hover:bg-white/20">Pemantauan Simpanan</a>
        <a href="#" class="block p-2 rounded hover:bg-white/20">Pemantauan Angsuran</a>
        <a href="#" class="block p-2 rounded hover:bg-white/20">Laporan & Audit</a>
        <a href="#" class="block p-2 rounded hover:bg-white/20">Pemantauan Transaksi</a>
