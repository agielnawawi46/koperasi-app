<aside class="w-64 min-h-screen bg-blue-900 text-white flex flex-col">
    ...
    <nav class="space-y-5 p-5">
        ...
        <a href="#" class="block p-3 rounded hover:bg-white/20">Simpanan Saya</a>
        <a href="#" class="block p-3 rounded hover:bg-white/20">Pengajuan Pinjaman</a>
        <a href="#" class="block p-3 rounded hover:bg-white/20">Angsuran saya</a>
        <a href="#" class="block p-3 rounded hover:bg-white/20">SHU</a>
